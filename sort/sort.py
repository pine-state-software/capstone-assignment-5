def bubble(_list):
    ...
    for i in range(length):
        ...
        if i + 1 == length:
            ...
            if sorted:
                return _list
            # Call function again for nth passthrough
            # if array elements were swapped
            else:
                return bubble(_list)
...
def insertion(_list, _position=0):
    ...
    for i in range(length)[_position:]:
        ...
        if i + 1 == length:
            ...
            # Swap last element of sorted sub list and first element
            #  of unsorted sublist if they are not in order
            if _list[i] > _list[i + 1]:
                _list[i], _list[i + 1] = _list[i + 1], _list[i]

                # Move new element down sorted sublist
            ...
            # increase size of sorted sublist and go to next passthrough.
            else:
                return insertion(_list, i + 1)
